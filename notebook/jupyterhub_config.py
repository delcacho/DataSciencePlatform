...
c.Spawner.env_keep = ['PATH', 'MLFLOW_TRACKING_URI', 'JAVA_HOME', 'HADOOP_HOME', 'MASTER', 'PYTHONPATH', 'PYSPARK_DRIVER_PYTHON','PYSPARK_DRIVER_PYTHON_OPTS','PYSPARK_PYTHON','SPARKMONITOR_UI_HOST','SPARKMONITOR_UI_PORT']
