...
os.system("kubectl exec -it "+key+" -- /usr/bin/wget http://localhost:8080/jnlpJars/jenkins-cli.jar -P /tmp")
#os.system("kubectl exec -it "+key+" -- /usr/local/openjdk-8/bin/java -jar /tmp/jenkins-cli.jar -auth admin:11ee1c7cb4a9daf80133c23476e2fa3fc0 -s http://localhost:8080 reload-configuration")
os.system("kubectl exec -it "+key+" -- /usr/local/openjdk-8/bin/java -jar /tmp/jenkins-cli.jar -s http://localhost:8080 reload-configuration")
